        ...
        try {
            ...
            const bucket = getStorage().bucket(bucketName);
                    ...
                    await file.save(pdfData, {
                        ...
                        // SECURITY FIX: NO public: true — stays private
                    });
                    // SECURITY FIX: NO file.makePublic()
                    // Return opaque storage key; closeLoan stores as documentId,
                    // reads go through authorized getDocumentUrl endpoint only
                    resolve(filename);
                } catch (uploadError) {
